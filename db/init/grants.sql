...
GRANT SELECT ON TABLE bookmazon.password_reset_tokens TO rl_sel;
...
GRANT DELETE ON TABLE bookmazon.password_reset_tokens TO rl_del;
...
GRANT UPDATE ON TABLE bookmazon.password_reset_tokens TO rl_upd;
...
GRANT INSERT ON TABLE bookmazon.password_reset_tokens TO rl_ins;